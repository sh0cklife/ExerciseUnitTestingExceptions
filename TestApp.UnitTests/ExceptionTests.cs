...
public class ExceptionTests
{
    ...
    public void Test_CalculateDiscount_ValidInput_ReturnsDiscountedPrice()
    {
        // Arrange
        decimal total = 500;
        decimal discounted = 50;
        // Act
        decimal result = this._exceptions.ArgumentCalculateDiscount(total, discounted);
        // Assert
    ...
    [Test]
    public void Test_DivideNumbers_ValidNegativeDivision_ReturnsQuotient()
    {
        // Arrange
        int dividend = 6;
        int divisor = -1;
